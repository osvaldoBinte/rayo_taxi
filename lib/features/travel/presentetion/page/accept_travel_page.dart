        ...
        children: [
          ...
          Obx(() {
            if (travelByIdController.state.value is TravelByIdAlertLoading) {
              ...
              return Center(child: Text("No hay datos del viaje disponibles."));
            }
          }),
              ...
              children: [
                Obx(() {
                  ...
                  if (travel.id_status == 3) {
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor: Colors.grey,  // Botón deshabilitado
                    ...
                    // Si el id_status no es 3, mostrar botón de aceptar viaje activo
            ...
            child: IconButton(
              ...
              onPressed: () {
                QuickAlert.show(
                  ...
                  text: travelByIdController.state.value is TravelByIdAlertLoaded
